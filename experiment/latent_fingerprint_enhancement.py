...
class TestNetwork(object):
    ...
    def _init_configure(self):
        ...
        parser.add_argument('--latent_fingerprint_dir', type=str, default=r'/data_lids/home/gabrielseabra/cartoon-decomposition/srcB/sd27_ref_texture')
        parser.add_argument('--out_dir', type=str, default='../enh_results_sd27_ref')
        parser.add_argument('--resume_path', type=str, default=r'../trained_model/FingerGAN_25850831.tar')
